...
export { SlackAdapter, assistantGreeting, mentionsByName, normalizeSlackEvent, reconnectDelay, resolveChannelRef, slackPermalink, type HistoryMessage, type SlackConfig } from './slack-adapter'
